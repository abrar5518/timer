    ...
    <div class="container auth-container fade-up">
      <div class="card glass auth-card">
        <div class="text-center mb-4">
          ...
          <h2>Welcome Back</h2>
          <p class="text-muted">Login to manage your events.</p>
        </div>
        ...
        <form @submit.prevent="handleLogin" class="auth-form">
          ...
          <div class="form-group">
            ...
            <div class="input-wrapper">
              ...
              <input type="password" class="input has-icon" v-model="password" required placeholder="••••••••" />
            </div>
          </div>
        ...
        <div class="auth-footer text-center mt-3">
          <p>Don't have an account? <router-link to="/register" class="link-primary">Create one for free</router-link></p>
        </div>
      </div>
    </div>
  </div>
